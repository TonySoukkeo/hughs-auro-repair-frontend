...
const PostCards = React.forwardRef(
  ({ title, body, postedDate, edited, id, showDeleteAlert }, ref) => {
    const modifyBody =
      body && body.length > 360 ? body.slice(0, 360) + "..." : body;

    return (
      <div ref={ref} className="dashboard__view-posts__posts">
        ...
        <div className="dashboard__view-posts__actions">
          ...
          <button onClick={() => showDeleteAlert(id)} className="btn btn--red">
            Delete
          </button>
